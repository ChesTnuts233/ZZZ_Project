...
namespace GameBuild
{
	public class KanojoMove : MovementBase
	{
		...
		public KanojoMove(MonoBehaviour mono, Rigidbody rb, Transform inputSpace, Transform player, Animator anim, IPlayerBase self) : base(mono, rb, inputSpace, player, anim, self)
		{
