...
namespace KooFrame
{
	...
	public class CodeMarkInspector : CodeInspector
	{
		...
		public override void BindToManagerWindow(KooCodeWindow managerWindow)
		{
			...
			container_assets = KooCode.SettingsData.MarkInspectorVisualTreeAsset;
		...
		public void UpdateInspector(CodeMarkData data)
		{
			...
			viewer = new MG.MDV.MarkdownViewer(KooCode.SettingsData.DarkSkin, curCheckMarkData.MarkDownPath, content);
		}
