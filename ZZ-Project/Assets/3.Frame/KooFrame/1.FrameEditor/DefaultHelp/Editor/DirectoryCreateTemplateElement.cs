...
namespace KooFrame
{
	public class DirectoryCreateTemplateElement : VisualElement
	{
		...
		private void BindPathLabel()
		{
			...
			curSelectPath.text = DefaultTipHelp.CurSelectPath;
		}
		...
		private void BindAndCreateListView()
		{
			...
			//这里创建并且读取所有的样本模板
			needCreatedsListView.CreateListView(KooCode.SettingsData.DefaultFoldNeedCreatedItemVisualAsset, needToCreateList);
