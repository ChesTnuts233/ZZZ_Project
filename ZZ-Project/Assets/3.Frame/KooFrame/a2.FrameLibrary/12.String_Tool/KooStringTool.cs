...
namespace KooFrame
{
	public static partial class KooTool
	{
		...
		private static readonly char[] LegalCharacters = "!@#$%^&*()-+=[]{}|;:'\",.<>/? ".ToCharArray();

		// 检查单个字符是否是合法字符
		private static bool IsLegalCharacter(char c)
		{
			return Array.IndexOf(LegalCharacters, c) != -1;
		}

		// 检测字符串中是否包含非法字符
		public static bool IsContainsIllegalCharacters(string input)
		{
