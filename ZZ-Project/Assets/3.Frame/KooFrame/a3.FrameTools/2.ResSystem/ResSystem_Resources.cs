...
namespace KooFrame
{
    public class ResSystem
    {
        ...
        public static void InitGameObjectPool(string keyName, int maxCapacity = -1, string assetPath = null,
        ...
        /// <param name="path">资源路径</param>
        /// <param name="parent">父物体</param>
        public static T InstantiateGameObject<T>(string assetPath, Transform parent = null, string keyName = null)
        ...
        /// 异步实例化游戏物体
        /// </summary>
        public static void InstantiateGameObjectAsync(string assetPath, Action<GameObject> callBack = null,
            Transform parent = null, string keyName = null)
        {
            // 切割路径获取实际的资源名称
            string assetName = GetAssetNameByPath(assetPath);
            GameObject go;
        ...
        public static void InstantiateGameObjectAsync<T>(string assetPath, Action<T> callBack = null,
            Transform parent = null, string keyName = null) where T : UnityEngine.Component
        {
            string assetName = GetAssetNameByPath(assetPath);
            // 缓存字典里面有
            GameObject go;
        ...
        static IEnumerator DoInstantiateGameObjectAsync(string assetPath, Action<GameObject> callBack = null,
        ...
        static IEnumerator DoInstantiateGameObjectAsync<T>(string assetPath, Action<T> callBack = null,
