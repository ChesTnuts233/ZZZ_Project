...
namespace KooFrame
{
    ...
    public class UISystem : MonoBehaviour
    {
        ...
        // public static T ShowAndBindCharacter<T>(ICharacter owner, string windowKey, int layer = -1)
        //     where T : UI_WindowBase
        // {
        //     return ShowAndBindCharacter(owner, windowKey, layer) as T;
        // }
        ...
        // /// <param name="windowKey">窗口的key</param>
        // /// <param name="layer">层级 -1等于不设置</param>
        // public static UI_WindowBase ShowAndBindCharacter(ICharacter owner, string windowKey, int layer = -1)
        // {
        //     if (UIWindowDataDic.TryGetValue(windowKey, out UIWindowData windowData))
        //     {
        //         return ShowWindow(windowData, windowKey, layer);
        ...
        //
        //     //游戏设置加载
        //     GameSettingsPanel.LoadGameSettings();
        //     //画面设置加载
        //     GraphicSettingsPanel.LoadGraphicSettings();
        //     //音量设置加载
        //     AudioSettingsPanel.LoadAudioSettings();
        // }
