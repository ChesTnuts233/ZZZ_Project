...
// #if UNITY_EDITOR
//
//         [SerializeField, LabelText("测试播放的BGM的Id"), FoldoutGroup("测试按钮"),BGMDescription, PropertySpace(5f,5f)]
//         private int TestBGMId;
//
//         [Button("播放BGM", 30), PropertySpace(5f, 5f), FoldoutGroup("测试按钮")]
//         protected void PlayBGMTest()
//         {
//             if(Application.isPlaying == false)
//             {
//                 Debug.Log("请在游戏启动的时候再使用此功能");
...
//             PlayBGM(TestBGMId);
//         }
//         [Button("切换到平静状态的BGM", 30), PropertySpace(5f, 5f), FoldoutGroup("测试按钮")]
//         protected void PlayPeaceBGM()
//         {
//             ChangeSoundTrack(AudioSystem.PeaceTrack);
//         }
//         [Button("切换到危险地区的BGM", 30), PropertySpace(5f, 5f), FoldoutGroup("测试按钮")]
//         protected void PlayDangerBGM()
//         {
//             ChangeSoundTrack(AudioSystem.DangerTrack);
//         }
//         [Button("切换到战斗状态的BGM", 30), PropertySpace(5f, 5f), FoldoutGroup("测试按钮")]
//         protected void PlayTTKBGM()
//         {
//             ChangeSoundTrack(AudioSystem.TTKTrack);
//         }
//         [Button("切换到残血战斗的BGM", 30), PropertySpace(5f, 5f), FoldoutGroup("测试按钮")]
//         protected void PlayTTK2BGM()
//         {
//             ChangeSoundTrack(AudioSystem.TTK2Track);
//         }
//         [Button("切换到狂怒状态的BGM", 30), PropertySpace(5f, 5f), FoldoutGroup("测试按钮")]
//         protected void PlayFuryBGM()
//         {
//             ChangeSoundTrack(AudioSystem.FuryTrack);
//         }
// #endif
//
//         #endregion
