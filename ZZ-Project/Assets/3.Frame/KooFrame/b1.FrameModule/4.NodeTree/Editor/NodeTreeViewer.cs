...
namespace KooFrame
{
    ...
    public class NodeTreeViewer : GraphView
    {
        ...
        public NodeTreeViewer()
        {
            ...
            var styleSheet =
                AssetDatabase.LoadAssetAtPath<StyleSheet>(
                    "Assets/3.Frame/KooFrame/b1.FrameModule/4.NodeTree/Editor/NodeTreeViewer.uss");
        ...
        public override void BuildContextualMenu(ContextualMenuPopulateEvent evt)
        {
            ...
            // {
            //     evt.menu.AppendAction($"{ChangeToChinese(type.Name)}", (a) => { CreateNode(type); });
            // }
